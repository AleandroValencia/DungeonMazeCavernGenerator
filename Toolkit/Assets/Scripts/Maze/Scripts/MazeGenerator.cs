...
public class MazeGenerator : MonoBehaviour
{
    ...
    public static string m_name = "Maze";
    public static int m_numRows = 2;
    public static int m_numColumns = 2;
    public static GameObject m_wall;
    public static GameObject m_floor;
    public static GameObject m_marker;
    public static GameObject m_markerFront;
    public static bool m_tiles = true;
    public static bool GenerateInRunTime = false;

    private static bool m_horizontalWall = false;
    private static GameObject m_mazeObject;
    private static Cell[] m_cells;

    private static int m_currentCell = 0;
    private static int m_totalCells = 0;
    private static int m_currentNeighbor = 0;
    private static int m_previousCell = 0;
    private static List<int> m_cellStack;
    private static WALLINDEX m_wallToBreak = 0;

    private static int m_endTileDistance = 0;
    private static Cell m_endCell;
    private static bool m_deadEnd = false;

    private static int m_markerCount = 0;
    private static List<Marker> m_markers;
    private static GameObject m_emptyGameObject;
    ...
    /// <summary>
    /// Reset values to 0 because of static script
    /// </summary>
    ...
    public static GameObject GenerateMaze()
    {
    ...
    static void CreateFloor(float _wallLength)
    {
    ...
    static GameObject GenerateMarker(Transform _wallParent)
    {
    ...
    static int NthTriangleNumber(int _n)
    {
        return ((_n * (_n + 1)) / 2);
    }
}
